...
export class SettingsComponent {
   ...
   */
  clearAllData(): void {
    const confirmed = confirm('क्या आप सभी डेटा हटाना चाहते हैं? यह कार्य अपरिवर्तनीय है।');
    if (confirmed) {
      localStorage.removeItem('harvester_records');
      alert('सभी डेटा सफलतापूर्वक हटा दिया गया');
    }
  }
   ...
   */
  resetSettings(): void {
    const confirmed = confirm('क्या आप सभी सेटिंग्स डिफ़ॉल्ट में रीसेट करना चाहते हैं?');
    if (confirmed) {
      ...
      alert('सेटिंग्स डिफ़ॉल्ट में रीसेट कर दी गई हैं');
    }
  }
